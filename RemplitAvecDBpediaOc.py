...
def main():
    ...
    ficentree2 = "topo_dbpedia.csv" 
    ficentree1 = "Toponimia.csv"
    ficresultat = "listeTopoOcDBpedia.csv"
    ficrejet1 = "rejetsToponimia.csv"
    ficrejet2 = "rejetsDBpedia.csv"
            ...
            try :
                ...
                try :
                    ...
                    try :
                        ...
                        print("Nombre de toponymes de DBPedia trouvés dans Toponimia :"+str(cpttrouve))
                        ...
                        for ligne in dbpediaville.items() :
                            ...
                            if ligne[0] not in dicoville :
                                ...
                                cpttrouve += 1
                        print("Nombre de toponymes de DBPedia non trouvés dans Toponimia :"+str(cpttrouve))
